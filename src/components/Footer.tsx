...
const Footer = () => {
  return (
    <div className="flex flex-row justify-center self-center w-screen">
      <footer className="flex flex-col space-y-2 self-end p-4 items-end bg-neutral-200 dark:bg-neutral-900 bg-opacity-30 w-full text-neutral-900 dark:text-neutral-100 overflow-hidden">
